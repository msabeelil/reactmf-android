...
const Button = () => {
  ...
  useEffect(() => {
    const fetchTrendingVideos = async () => {
      ...
      const authToken =
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..NCvTjNZ-fgWuNkHJy5xgp5OlaRyMC-jPLiCBcP9rYYs";
      try {
